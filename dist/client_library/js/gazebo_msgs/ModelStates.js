(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f();}else if(typeof define==="function"&&define.amd){define([],f);}else{var g;if(typeof window!=="undefined"){g=window;}else if(typeof global!=="undefined"){g=global;}else if(typeof self!=="undefined"){g=self;}else{g=this;}if(typeof g.gazebo_msgs==="undefined"){g.gazebo_msgs={};}g.gazebo_msgs.ModelStates=f();}})(function(){var define,module,exports;'use strict';
...
ModelStates.prototype.serialize = function(buff, idx) {
    var offset = idx;
...
ModelStates.prototype.deserialize = function(buff, idx) {
    var offset = idx;
...
ModelStates.prototype.serializedLength = function() {
    var length = 0;
    var length_name = this.name.length;
    length += 4;
    for (var i = 0; i < length_name; i++) {
...
ModelStates.prototype.echo = function() { return ""; };

ModelStates.prototype.getType = function() { return "gazebo_msgs/ModelStates"; };

ModelStates.prototype.getMD5 = function() { return "05074231128e3d50825a5f46d9217fda"; };

ModelStates.prototype.getID = function() { return 0; };

ModelStates.prototype.setID = function(id) { };

return function() { return new ModelStates(); };
