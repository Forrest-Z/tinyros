(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f();}else if(typeof define==="function"&&define.amd){define([],f);}else{var g;if(typeof window!=="undefined"){g=window;}else if(typeof global!=="undefined"){g=global;}else if(typeof self!=="undefined"){g=self;}else{g=this;}if(typeof g.std_msgs==="undefined"){g.std_msgs={};}g.std_msgs.Int64MultiArray=f();}})(function(){var define,module,exports;'use strict';
...
Int64MultiArray.prototype.serialize = function(buff, idx) {
    var offset = idx;
...
Int64MultiArray.prototype.deserialize = function(buff, idx) {
    var offset = idx;
...
Int64MultiArray.prototype.serializedLength = function() {
    var length = 0;
...
Int64MultiArray.prototype.echo = function() { return ""; };

Int64MultiArray.prototype.getType = function() { return "std_msgs/Int64MultiArray"; };

Int64MultiArray.prototype.getMD5 = function() { return "c06d166bcec6ac0d57a5122b314c9f5c"; };

Int64MultiArray.prototype.getID = function() { return 0; };

Int64MultiArray.prototype.setID = function(id) { };

return function() { return new Int64MultiArray(); };
