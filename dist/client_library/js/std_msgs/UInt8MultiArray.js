(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f();}else if(typeof define==="function"&&define.amd){define([],f);}else{var g;if(typeof window!=="undefined"){g=window;}else if(typeof global!=="undefined"){g=global;}else if(typeof self!=="undefined"){g=self;}else{g=this;}if(typeof g.std_msgs==="undefined"){g.std_msgs={};}g.std_msgs.UInt8MultiArray=f();}})(function(){var define,module,exports;'use strict';
...
UInt8MultiArray.prototype.serialize = function(buff, idx) {
    var offset = idx;
...
UInt8MultiArray.prototype.deserialize = function(buff, idx) {
    var offset = idx;
...
UInt8MultiArray.prototype.serializedLength = function() {
    var length = 0;
...
UInt8MultiArray.prototype.echo = function() { return ""; };

UInt8MultiArray.prototype.getType = function() { return "std_msgs/UInt8MultiArray"; };

UInt8MultiArray.prototype.getMD5 = function() { return "ed0dcee956eb67c464fc17fa893003bb"; };

UInt8MultiArray.prototype.getID = function() { return 0; };

UInt8MultiArray.prototype.setID = function(id) { };

return function() { return new UInt8MultiArray(); };
