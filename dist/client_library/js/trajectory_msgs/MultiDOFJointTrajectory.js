(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f();}else if(typeof define==="function"&&define.amd){define([],f);}else{var g;if(typeof window!=="undefined"){g=window;}else if(typeof global!=="undefined"){g=global;}else if(typeof self!=="undefined"){g=self;}else{g=this;}if(typeof g.trajectory_msgs==="undefined"){g.trajectory_msgs={};}g.trajectory_msgs.MultiDOFJointTrajectory=f();}})(function(){var define,module,exports;'use strict';
const _CURRENT_PATH_ = document.currentScript.src.substring(0, document.currentScript.src.lastIndexOf("/"));
const _ROOT_PATH_ = _CURRENT_PATH_.substring(0, _CURRENT_PATH_.lastIndexOf("/"));
document.write("<script language=javascript src='"+_ROOT_PATH_+"/std_msgs/Header.js'></script>");
document.write("<script language=javascript src='"+_ROOT_PATH_+"/trajectory_msgs/MultiDOFJointTrajectoryPoint.js'></script>");

function MultiDOFJointTrajectory() {
    this.header = std_msgs.Header();
    this.joint_names = new Array();
    this.points = new Array();
};

MultiDOFJointTrajectory.prototype.serialize = function(buff, idx) {
    var offset = idx;
...
MultiDOFJointTrajectory.prototype.deserialize = function(buff, idx) {
    var offset = idx;
    ...
    for (var i = 0; i < length_points; i++) {
        this.points[i] = trajectory_msgs.MultiDOFJointTrajectoryPoint();
        offset = this.points[i].deserialize(buff, offset);
    }
    return offset;
};

MultiDOFJointTrajectory.prototype.serializedLength = function() {
    var length = 0;
...
MultiDOFJointTrajectory.prototype.echo = function() { return ""; };

MultiDOFJointTrajectory.prototype.getType = function() { return "trajectory_msgs/MultiDOFJointTrajectory"; };

MultiDOFJointTrajectory.prototype.getMD5 = function() { return "19f97d4cdcae9d0ef55126c1495f6c91"; };

MultiDOFJointTrajectory.prototype.getID = function() { return 0; };

MultiDOFJointTrajectory.prototype.setID = function(id) { };

return function() { return new MultiDOFJointTrajectory(); };
