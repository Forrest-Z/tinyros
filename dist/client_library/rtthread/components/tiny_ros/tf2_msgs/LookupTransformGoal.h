...
namespace tf2_msgs
{
  ...
  {
    public:
      typedef tinyros::string _target_frame_type;
      _target_frame_type target_frame;
      typedef tinyros::string _source_frame_type;
      ...
      typedef tinyros::string _fixed_frame_type;
    ...
    virtual tinyros::string getType(){ return "tf2_msgs/LookupTransformGoal"; }
    virtual tinyros::string getMD5(){ return "677c84a912b788ccaaea5fbc38570182"; }
