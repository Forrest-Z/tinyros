...
static const char FRAMEGRAPH[] = "tf2_msgs/FrameGraph";
  ...
  class FrameGraphRequest : public tinyros::Msg
  {
    ...
    virtual tinyros::string getMD5(){ return "aa023d3c31410363e0583979223258c8"; }
  ...
  class FrameGraphResponse : public tinyros::Msg
  {
    ...
    public:
      typedef tinyros::string _frame_yaml_type;
    ...
    virtual tinyros::string getType(){ return FRAMEGRAPH; }
    virtual tinyros::string getMD5(){ return "97e361486f8cc8fb1a460cf17555126b"; }
    uint32_t getID() const { return this->__id__; }
    void setID(uint32_t id){ this->__id__ = id; }
