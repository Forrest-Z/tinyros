...
namespace tf2_msgs
{
  ...
  class LookupTransformActionFeedback : public tinyros::Msg
  {
    public:
      ...
      _status_type status;
      typedef tinyros::tf2_msgs::LookupTransformFeedback _feedback_type;
    ...
    virtual tinyros::string getType(){ return "tf2_msgs/LookupTransformActionFeedback"; }
    virtual tinyros::string getMD5(){ return "f432c3fa33a3ac9586ace248b606de3a"; }
