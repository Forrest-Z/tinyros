...
namespace tf2_msgs
{
  ...
  class TF2Error : public tinyros::Msg
  {
    public:
      ...
      _error_type error;
      typedef std::string _error_string_type;
    ...
    virtual std::string getType(){ return "tf2_msgs/TF2Error"; }
    virtual std::string getMD5(){ return "ed32adf5a372962d977aea0e5630d1d6"; }
