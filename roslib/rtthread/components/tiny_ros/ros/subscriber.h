...
public:
  ...
  Subscriber(tinyros::string topic_name, CallbackT cb, ObjT* obj, int endpoint = tinyros::tinyros_msgs::TopicInfo::ID_SUBSCRIBER) :
    cb_(cb),
    obj_(obj),
    endpoint_(endpoint) {
    topic_ = topic_name;
...
public:
  ...
  Subscriber(tinyros::string topic_name, CallbackT cb, int endpoint = tinyros::tinyros_msgs::TopicInfo::ID_SUBSCRIBER) :
    cb_(cb),
    endpoint_(endpoint) {
    topic_ = topic_name;
    negotiated_ = false;
